    ...
    return (
        <div className="navbar bg-base-100 shadow-sm">
            ...
            <div className="mynewclass flex items-center navbar-end">
                ...
                {
                    userData ? <button onClick={() => navigate("signup")} className={`rounded-md flex justify-center items-center px-3.5 py-1.5 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium bg-[#DC143C] border-[#DC143C]`}>
